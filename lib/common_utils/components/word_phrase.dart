...
class PhraseWords extends StatefulWidget {
  ...
  @override
  _PhraseWordsState createState() => _PhraseWordsState();
}

class _PhraseWordsState extends State<PhraseWords>
      ...
      child: Column(
        ...
        children: [
          ...
          ...text.split('¥n').map((line) => Text(
                line,
                style: const TextStyle(color: Colors.white, fontSize: 19.2),
              )),
        ],
      ),
    );
